...
import 'package:pam_2026_p6_ifs23008/shared/widgets/top_app_bar_widget.dart';
...
void main() {
  group('TopAppBarWidget', () {
    testWidgets('menampilkan judul dengan benar', (tester) async {
      await tester.pumpWidget(buildTestApp(
        child: const Scaffold(
          appBar: TopAppBarWidget(title: 'Delcom Farm'),
          body: SizedBox(),
        ),
      ));

      expect(find.text('Delcom Farm'), findsOneWidget);
    });
    ...
    testWidgets('menampilkan tombol back saat showBackButton = true',
          ...
          await tester.pumpWidget(buildTestApp(
            child: const Scaffold(
              appBar: TopAppBarWidget(title: 'Detail Hewan', showBackButton: true),
              body: SizedBox(),
            ),
          ));
    ...
    testWidgets('menampilkan tombol toggle light mode', (tester) async {
      ...
      // Dalam light mode, ikon yang tampil adalah light_mode_outlined
    ...
    testWidgets('menampilkan tombol search saat withSearch = true',
          ...
          await tester.pumpWidget(buildTestApp(
            child: const Scaffold(
              appBar: TopAppBarWidget(title: 'Farm', withSearch: true),
              body: SizedBox(),
            ),
          ));
    ...
    testWidgets('hint text search mengandung kata "hewan ternak"',
            (tester) async {
          await tester.pumpWidget(buildTestApp(
            child: const Scaffold(
              appBar: TopAppBarWidget(title: 'Farm', withSearch: true),
          ...
          // Cek hint text di dalam TextField
          final textField = tester.widget<TextField>(find.byType(TextField));
          expect(textField.decoration?.hintText, contains('hewan ternak'));
        });
